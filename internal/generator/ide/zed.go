...
//     clang-format, editor and terminal preferences, inlay hints
...
//	  - Line ending detected from file content
...
const tmplZedSettings = `{
  ...
  "languages": {
    ...
    "C++": {
      ...
      // Detecta o fim de linha existente no arquivo em vez de forçar um.
      "line_ending": "detect"
    },
